...
class AdvertiserTwoProvider extends AbstractProvider implements HotelProviderInterface
{
    private const API_URL = 'https://coresolutions.app/php_task/api/api_v2.php';
